...
<head>
    ...
    <title>Griya Sarre | Registration</title>
        ...
        <div class="card card-outline card-primary">
            ...
            <div class="card-body">
                ...
                <form method="post" id="registration">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <button type="submit" id="register" class="btn btn-primary btn-block" name="registerBtn">Register</button>
                        </div>
                        <!-- /.col -->
                    </div>
                </form>
                <span class="text-center">Already have account? <a href="login.php">Sign in.</a></span>
            </div>
            <!-- /.form-box -->
        </div><!-- /.card -->
    </div>
